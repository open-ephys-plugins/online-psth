...
Histogram::Histogram (OnlinePSTHDisplay* display_, const SpikeChannel* channel, const TriggerSource* source_)
    : display (display_), sample_rate (channel->getSampleRate()), spikeChannel (channel), source (source_), baseColour (source_->colour), streamId (channel->getStreamId()), waitingForWindowToClose (false), latestEventSampleNumber (0)
{
    pre_ms = 0;
    post_ms = 0;
    bin_size_ms = 10;
