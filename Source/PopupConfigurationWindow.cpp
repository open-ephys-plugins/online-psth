                                                          ...
                                                          Component* existingComponentToUpdate)
{
    if (columnId == OnlinePSTHTableModel::Columns::NAME)
    {
        ...
        if (textLabel == nullptr)
        {
            ...
            textLabel = new EditableTextCustomComponent (processor, triggerSources[rowNumber], acquisitionIsActive);
        }
    ...
    : PopupComponent ((Component*) editor_), editor (editor_)
{
    ...
    triggerSourceGenerator = std::make_unique<TriggerSourceGenerator> (editor, this, 16, acquisitionIsActive);
